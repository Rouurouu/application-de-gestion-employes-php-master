...
if(isset($_POST['submit'])):
   ...
   $salaire = htmlentities(trim($_POST['salaire'])); // New salary field
   ...
   elseif(empty($salaire)):
      $errors =  'Veuillez entrer le salaire'; // Validation for salary
   else :
      $values = array(
         'nom' => $nom,
         'prenom' => $prenom,
         ...
         'service' => $service,
         'matricule' => $matricule,
         'salaire' => $salaire, // Include salary in the array
      );
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="update.php?id=<?php echo $row['id'];?>" method="post">
                             ...
                             <div class="form-group">
                                   <label for="salaire">Salaire*</label> <!-- New salary input -->
                                   <input type="text" class="form-control" placeholder="Salaire" name="salaire" id="salaire" value="<?php echo isset($row['salaire']) ? $row['salaire'] : '';?>">
                             </div>
                             <div class="form-group">
